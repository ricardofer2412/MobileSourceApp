...
class RepairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post repairs_url, params: { repair: { model_name: @repair.model_name, part_cost: @repair.part_cost, repair_price: @repair.repair_price } }
    end
  ...
  test "should update repair" do
    patch repair_url(@repair), params: { repair: { model_name: @repair.model_name, part_cost: @repair.part_cost, repair_price: @repair.repair_price } }
